...
Date:       02.02.2023
Parameters: 
        Showing the effect of signalling in a binary way on the group efficiency
        with moving resource patch with 5 agents.  
...
criteria_exp = [
    ...
    Tunable("SIGNALLING_PROB", values_override=[0, 0.25, 0.5, 0.75, 1]),
    ...
    Tunable("RES_VEL", values_override=[1, 1.5, 2, 2.5]),
    Constant("METER_TO_RES_MULTI", 1),
    Constant("DETECTION_RANGE", 75),
    Constant("T", 25000),
]
