...
detection_ranges = [1, 3, 5, 7, 10, 15, 20, 25, 30]
detection_ranges = [i*agent_radius for i in detection_ranges]
signaling_probs = [0, 0.25, 0.5, 0.75, 1]
...
criteria_exp = [
    ...
    # Taxis
    Constant("PHOTOTAX_THETA_FAC", 0.42),  # increasing turning rate to double during taxis as our agents can not stop
    # Signaling
    ...
    Tunable("DETECTION_RANGE", values_override=detection_ranges),
    Constant("T", 25000),
]
