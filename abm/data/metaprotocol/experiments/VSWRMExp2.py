...
Date:       30.01.2024
Parameters: 
        This is the second experiment for visual flocking of robots article exploring the effects of
        the main control aparameters of the visual flocking model (i.e. a0, b0) with systematically
        limiting the field of view in a confined environment with reflective walls
