...
Date:       22.03.2023
Parameters: 
        Validating diff calculation error by reproducing main results from Bastein and Romanczuk paper,
        and checking the effect of field of view with walls
...
criteria_exp = [
    ...
    Constant("VISUAL_FIELD_RESOLUTION", 600),
    ...
    Constant("VF_BET2", 0),
    Tunable("AGENT_FOV", values_override=[0.5, 0.75, 1]),  # unlimited FOV
    Constant("BOUNDARY", "walls"),
    Constant("T", 25000),
    Constant("N", 10),  # Can not be tuned, must be fixed for Replay tool
    Tunable("VF_ALP0", values_override=[0, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5, 0.75, 1, 2, 5]),
    Tunable("VF_BET0", values_override=[0, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5, 0.75, 1, 2, 5])
]
