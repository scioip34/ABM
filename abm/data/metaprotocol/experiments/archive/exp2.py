...
criteria_exp = [
    Constant("N", 10),
    Constant("AGENT_FOV", 0.95),  # almost full FOV
    ...
    Constant("DEC_SWU", 0),
    Constant("DEC_SUW", 0),
    Tunable("N_RESOURCES", values_override=[1, 2, 3, 4, 5, 7, 10]),
    Constant("T", 10000)
]

# Creating metaprotocol and add defined criteria
mp = MetaProtocol(experiment_name="Experiment2_10agents_batch3", num_batches=1, parallel=True)
