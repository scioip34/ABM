...
fixed_criteria = [
    ...
    Constant("ENV_WIDTH", 300),
    Constant("ENV_HEIGHT", 300),
...
criteria_exp = [
    ...
    Constant("MIN_RESOURCE_PER_PATCH", 500),
    Constant("MAX_RESOURCE_PER_PATCH", 501),
    Constant("DEC_SWU", 0),
    Constant("DEC_SUW", 0),
    Constant("N_RESOURCES", 2),
    Constant("T", 10000)
]

# Creating metaprotocol and add defined criteria
mp = MetaProtocol(experiment_name="Experiment4_new", num_batches=9, parallel=True)
