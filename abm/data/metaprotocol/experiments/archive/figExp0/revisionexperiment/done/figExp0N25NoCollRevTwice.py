...
Date:       18.03.2024
Parameters: figExp0N5NoCollRevTwice:
                Experiment for revision #1: We take twice as many resource units as in the main text         
...
sum_resources = 4800  # twice of the main text
...
criteria_exp = [
    Constant("AGENT_AGENT_COLLISION", 0),  # turning off all agent-agent collisions
    Constant("N", 25),
