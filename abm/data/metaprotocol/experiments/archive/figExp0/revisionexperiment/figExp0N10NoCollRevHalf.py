...
Date:       18.03.2024
Parameters: figExp0N10NoCollRevHalf:
                Experiment for revision #1: We take half as many resource units as in the main text         
...
sum_resources = 1200  # half of the main text
