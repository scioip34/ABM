...
Date:       21.03.2024
Parameters: figExp0N25NoCollRevQuad:
                Experiment for revision #1: We take 4x as many resource units as in the main text         
...
sum_resources = 9600  # 4x of the main text
