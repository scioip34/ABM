...
evoprot = EvoProtocol(num_generations=30, gen_lifetime=10000, headless=True,
...
evoprot.set_env_var("N_RESOURCES", 2)
...
evoprot.set_env_var("MIN_RESOURCE_PER_PATCH", 1000)
