...
Date:       27.05.2022
Parameters: expFig1p1: After the 17 preliminary experiments we decided on the following experimental setting:
...
Experiment: In this experiment we use the above decribed golden standard parameters for simulations with:
                - 10 agents
                - Fully idealistic vision: no occlusions and full FOV
