...
Goal:       In this experiment we restrict the total amount of resources as before, but when we change the number
            ...
            patches in Experiment 5-7. Visual exclusion is on as in #5-6. Number of patches are changed in
            more extreme ways than in #5-6 as now the arena does not get saturated with patches.
Defined by: mezdahun
"""
...
mp = MetaProtocol(experiment_name="Experiment8", num_batches=10, parallel=False,
