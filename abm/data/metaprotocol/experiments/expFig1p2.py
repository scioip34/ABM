...
Date:       30.05.2022
Parameters: expFig1p2: After the 17 preliminary experiments we decided on the following experimental setting:
...
Experiment: In this experiment we use the above decribed golden standard parameters for simulations with:
                - 10 agents
                - Semi-idealistic vision: WITH occlusions but full FOV
